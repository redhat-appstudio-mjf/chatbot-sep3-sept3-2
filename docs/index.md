...
!!! info
    ...
    **Source Code Repository:** [https://github.com/redhat-appstudio-mjf/chatbot-sep3-sept3-2](https://github.com/redhat-appstudio-mjf/chatbot-sep3-sept3-2)

    **GitOps Repository:** [https://github.com/redhat-appstudio-mjf/chatbot-sep3-sept3-2-gitops](https://github.com/redhat-appstudio-mjf/chatbot-sep3-sept3-2-gitops)

# **Usage**

To access the chatbot-sep3-sept3-2 application that was deployed using the Software Template, complete the following instructions:
